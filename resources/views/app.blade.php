...
<head>
    ...
    <title>{{ (isset($title)) ? $title: 'TDH - Hospital Information System' }}</title>
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="{{ url('/') }}" class="logo">
            ...
            <span class="logo-lg"><img src="{{ url('img/logo-white.png') }}" width="32px" /> <b>Hospital</b>System</span>
        </a>
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="{{ url('upload/thumbs/default.png') }}" class="user-image" alt="User Image">
                            <span class="hidden-xs">{{ $user->fname }} {{ $user->lname }}</span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- User image -->
                            <li class="user-header">
                                <img src="{{ url('upload/thumbs/default.png') }}" class="img-circle" alt="User Image">

                                <p>
                                    {{ $user->fname }} {{ $user->lname }}
                                    <small>{{ \App\Department::find($user->dept_code)->code }}</small>
                                    <small>{{ \App\Position::find($user->pos_code)->name }}</small><br />
                                </p>
                            </li>
                            <!-- Menu Body -->
                            <!-- Menu Footer-->
...
<!-- /.content-wrapper -->
    <footer class="main-footer">
        ...
        <strong><a href="#">Hospital System</a>.</strong> All rights
        reserved.
    </footer>
